...
func FetchVPARecommendations(vpaName, namespace string) (*autoscaling.VerticalPodAutoscaler, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("failed to get VPA recommendations: %w", err)
	}
